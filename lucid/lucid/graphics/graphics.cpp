...
bool lucid_engine::graphics::create_device() {
    if (direct_3d->CreateDevice(D3DADAPTER_DEFAULT, D3DDEVTYPE_HAL, g_window.get( )->get_hwnd(), D3DCREATE_HARDWARE_VERTEXPROCESSING, &direct_3d_paramaters, &direct_3d_device) < 0) {
...
void lucid_engine::graphics::reset_device() {
    ...
    g_renderer.get( )->destroy_objects();
